    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted">
      ...
      <header className="container mx-auto px-4 sm:px-6 py-4 sm:py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg sm:text-xl font-bold">HacknationAI</span>
          </div>
        </div>
      </header>
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-24 lg:py-32">
        <div className="max-w-5xl mx-auto text-center space-y-6 sm:space-y-8">
          <div className="inline-block animate-fade-in">
            <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl gradient-primary shadow-glow mb-4 sm:mb-6">
              <Mic className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-primary-foreground" />
            </div>
          </div>
          
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-tight px-2 animate-fade-in">
            Voice CRM Agent for Customer Experience & Reviews
          </h1>
          
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto px-4 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center pt-4 sm:pt-6 md:pt-8 px-4 animate-fade-in">
            <Button 
              size="lg" 
              className="w-full sm:w-auto text-base sm:text-lg px-8 sm:px-10 md:px-12 py-6 sm:py-7 gradient-primary shadow-glow hover:opacity-90 transition-all font-semibold"
          ...
          <p className="text-xs sm:text-sm text-muted-foreground px-4 animate-fade-in">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
            {features.map((feature, idx) => (
              <Card key={idx} className="p-5 sm:p-6 space-y-3 sm:space-y-4 shadow-card hover:shadow-glow transition-all hover-scale">
                <div className="p-2.5 sm:p-3 rounded-lg sm:rounded-xl bg-primary/10 w-fit text-primary">
                  {feature.icon}
                </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        <div className="max-w-4xl mx-auto">
          <Card className="p-6 sm:p-8 md:p-10 lg:p-12 shadow-card">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-6 sm:mb-8 px-2">
        ...
        <div className="max-w-4xl mx-auto space-y-8 sm:space-y-10 md:space-y-12">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="flex gap-4 sm:gap-5 md:gap-6 items-start">
              <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-full gradient-primary flex items-center justify-center text-primary-foreground font-bold text-base sm:text-lg shadow-glow">
                1
              </div>
              <div className="pt-1 sm:pt-2">
                <h3 className="text-lg sm:text-xl md:text-2xl font-semibold mb-1.5 sm:mb-2">
      ...
      {/* CTA Section */}
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 pb-16 sm:pb-24 md:pb-32">
        <Card className="max-w-4xl mx-auto p-8 sm:p-10 md:p-12 lg:p-16 text-center space-y-4 sm:space-y-5 md:space-y-6 gradient-primary shadow-glow">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-foreground px-2">
          ...
          <Button 
            size="lg" 
            variant="secondary"
            className="w-full sm:w-auto text-base sm:text-lg px-8 sm:px-10 md:px-12 py-6 sm:py-7 mt-2 sm:mt-4 md:mt-6 font-semibold shadow-elegant"
            onClick={() => navigate("/purchase")}
          >
